...
const AboutPage = () => {
    return (
        <div id="about_me">
            <div className="h-24 bg-gradient-to-b from-stone-400 via-stone-600 to-stone-700"></div>
            <div className="w-[100vw] h-[40vh] sm:h-[50vh] md:h-[70vh] lg:h-[80vh] xl:h-[90vh] 2xl:h-[100vh]
                            bg-no-repeat bg-cover bg-gradient-to-b from-stone-700 via-stone-800 to-stone-900">
                ...
                <div className="container m-auto grid grid-cols-2">
                    ...
                    <div class="max-w-sm rounded-lg overflow-hidden shadow-lg my-10 sm:my-20">
                        <img class="w-full" src={fej_pic} />
                    </div>
                </div>
            </div>
        </div>
