        ...
        <div id="jst_about">
            <div className="bg-gradient-to-b from-stone-600 via-stone-700 to-stone-900">
                ...
                <div className="container m-auto">
                    ...
                    <div className="container mx-auto text-gray-400 font-roboto_slab mt-3 sm:mt-6 pb-5 sm:pb-10">
                    ...
                    <a href="./JeffTurnerResume2023.pdf" download>
                        <button class="bg-gray-400 hover:bg-amber-50 p-2 rounded">
                            <span className="inline-flex">
                                ...
                                <p className="font-roboto_slab md:text-lg text-md ml-4">Download Resume</p>
                            </span>
                        </button>
                    </a>
                </div>
