                ...
                className="bg-gradient-to-b from-stone-200 from-10% via-stone-400 via-60% to-stone-600 to-90%">
                    <div className="container m-auto grid grid-cols-2">
                        <div className="container mx-auto text-gray-800 font-roboto_slab py-10 sm:py-20 md:py-30 lg:py-40">
                            <h1 className="py-5 px-5 flex-initial text-2xl sm:text-3xl md:text-4xl lg:text-5xl">My name is Jeff.</h1>
                            <h1 className="py-5 px-5 flex-initial text-lg sm:text-xl md:text-2xl lg:text-3xl">I'm a creative software developer with experience in front-end and back-end development. Let me take your ideas and put them into motion.</h1>
                        </div>
